...
import com.example.wsbp.page.ChatPostPage;
...
public class SignedPage extends WebPage {
    ...
    public SignedPage() {
        ...
        // チャット投稿ページへのリンクを追加
        add(new BookmarkablePageLink<>("toChatPostLink", ChatPostPage.class));

        // チャット閲覧ページへのリンクを追加
        add(new BookmarkablePageLink<>("toChatLink", ChatPage.class));
